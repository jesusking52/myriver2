...
public class ProfileStudentLessonInfoPatchPresenter extends BasePresenter<ProfileStudentLessonInfoPatchMvpView> {
    private final DataManager dataManager;
    private Subscription subscription;

    @Inject
    ProfileStudentLessonInfoPatchPresenter(DataManager dataManager) {
        this.dataManager = dataManager;
    }

    @Override
    public void attachView(ProfileStudentLessonInfoPatchMvpView mvpView, Context context) {
