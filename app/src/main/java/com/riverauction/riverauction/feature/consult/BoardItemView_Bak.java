...
public class BoardItemView_Bak extends LinearLayout {
    ...
    public BoardItemView_Bak(Context context) {
        super(context);
        initialize(context);
    }

    public BoardItemView_Bak(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(context);
    }

    public BoardItemView_Bak(Context context, AttributeSet attrs, int defStyleAttr) {
...
/*
    private void setLessonStatusAndTime(CBoard board) {
        CLessonStatus lessonStatus = board.getStatus();
