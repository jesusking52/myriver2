...
public class ReviewInfoView2 extends LinearLayout {
    ...
    public ReviewInfoView2(Context context) {
        super(context);
        initialize(context);
    }
    ...
    public ReviewInfoView2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initialize(Context context) {
        ...
        inflater.inflate(R.layout.layout_review_info_view2, this, true);
