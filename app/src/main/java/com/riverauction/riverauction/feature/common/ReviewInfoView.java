...
public class ReviewInfoView extends LinearLayout {
    ...
    public ReviewInfoView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(context);
    }

    public ReviewInfoView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initialize(Context context) {
        ...
        inflater.inflate(R.layout.layout_review_info_view, this, true);
