...
public class ProfileStudentBasicInfoPatchPresenter extends BasePresenter<ProfileStudentBasicInfoPatchMvpView> {
    private final DataManager dataManager;
    private Subscription subscription;

    @Inject
    ProfileStudentBasicInfoPatchPresenter(DataManager dataManager) {
        this.dataManager = dataManager;
    }

    @Override
    public void attachView(ProfileStudentBasicInfoPatchMvpView mvpView, Context context) {
