...
public class ProfileTeacherLessonInfoPatchPresenter extends BasePresenter<ProfileTeacherLessonInfoPatchMvpView> {
    private final DataManager dataManager;
    private Subscription subscription;

    @Inject
    ProfileTeacherLessonInfoPatchPresenter(DataManager dataManager) {
        this.dataManager = dataManager;
    }

    @Override
    public void attachView(ProfileTeacherLessonInfoPatchMvpView mvpView, Context context) {
